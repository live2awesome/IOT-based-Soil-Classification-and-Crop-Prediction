...
public class PubSubActivity extends AppCompatActivity {
    ...
    private static final String CUSTOMER_SPECIFIC_ENDPOINT = "a1ao7nybrmp28m-ats.iot.us-east-2.amazonaws.com";

    // Cognito pool ID. For this app, pool needs to be unauthenticated pool with
    // AWS IoT permissions.
    private static final String COGNITO_POOL_ID = "us-east-2:bf2ccbf9-d36f-45f0-946e-e2e042ec4279";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtSubscribe = (EditText) findViewById(R.id.txtSubcribe);
