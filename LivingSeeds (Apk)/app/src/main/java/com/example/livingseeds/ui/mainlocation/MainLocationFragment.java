package com.example.livingseeds.ui.mainlocation;
...
public class MainLocationFragment extends Fragment {
    ...
    private MainLocationViewModel mViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(MainLocationViewModel.class);
